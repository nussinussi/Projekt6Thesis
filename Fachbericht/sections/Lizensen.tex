\section{Lizensen}
In diesem Kapitel werden, die Lizensen, welche in der Software genutzt werden behandelt. In der Tabelle \ref{tab: Lizensen} sind die Lizensen der verwendeten Bibliothek aufgeführt und für was sie verwendet wurden. Die Standard GNU GPL erlaubt die Verwendung nur für freie Software und die aufgeführte GNU LGPL auch für proprietäre Software \cite{noauthor_gnuorg_nodate}. Iostream ist unter GNU Lizens, was unsere Software ebenso unter dieser Lizens stellt.
