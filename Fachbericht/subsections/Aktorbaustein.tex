...
\begin{align}
\begin{split}
40\,MHz \text{Takt} \to 40\,kHz \text{PWM Zeitkonstante} \tau \\
= 1000/40 kHz = 25\,ms \to \text{Zeit bis zum Endwert}\\
t_{end} = \tau \cdot ln(1024) = 173\,ms \to Grenzfrequenz fg = 1/\tau = 40\,Hz
\end{split} \label{eq: Grenzfrequenz}
\end{align}
